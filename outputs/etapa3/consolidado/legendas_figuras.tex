...
% Arquivos PNG em outputs/etapa3/latour_2013_aime_en/figuras/. Apos
% copiar os PNG para o diretorio de figuras da tese, ajuste o path em
...
% militar, articulacao topologia+trajectory_pass, distribuicao
% homogenea de \texttt{Moderns} ao longo do livro) estao todas
% documentadas no \texttt{outputs/etapa3/consolidado/relatorio_etapa3.md}.
...
\texttt{trajectory\_pass} (433 ocorrencias) e \texttt{moderns} (397)
...
operacao teorica do livro e de justaposicao: o livro conserva o
vocabulario herdado e lhe acrescenta o vocabulario novo. Soma de 3.557
ocorrencias em 194.454 palavras
de corpo. Sem validacao amostral semantica nesta etapa; os campos de
alta polissemia (\texttt{experience}, \texttt{domain\_category})
carregam ruido nao estimado, conforme registro em
\texttt{outputs/etapa3/consolidado/relatorio\_etapa3.md} secao 8. Figura
gerada por \texttt{scripts/arquivo/23\_etapa3\_aime\_visualizacoes.py} a
partir de
\texttt{outputs/etapa3/latour\_2013\_aime\_en/csv/kwic\_catalogo\_antigo.csv}
...
primeira: \texttt{moderns} e \texttt{Moderns} (em laranja-claro,
...
designacao que da subtitulo a obra, a \enquote{antropologia dos
modernos}. A segunda: \texttt{topologia} e
\texttt{trajectory\_pass} concentram densidade muito alta na primeira
...
(\texttt{trajectory\_pass}, \texttt{moderns},
\texttt{domain\_category}, \texttt{experience},
\texttt{institution}, \texttt{modes\_of\_existence}, \texttt{alteration},
\texttt{felicity}) reforca a leitura de \emph{AIME} como livro de
...
matplotlib. Fonte:
\texttt{outputs/etapa3/latour\_2013\_aime\_en/csv/kwic\_catalogo\_antigo.csv}
e \texttt{kwic\_catalogo\_aime.csv} (coluna \texttt{posicao\_no\_texto}
em offsets de caractere). Figura gerada por
\texttt{scripts/arquivo/23\_etapa3\_aime\_visualizacoes.py}.}
...
\texttt{diplomacy} com 84 ocorrencias, \texttt{preposition} com 71,
...
\texttt{trajectory\_pass}), e parte do que a Etapa 3 documenta sobre
