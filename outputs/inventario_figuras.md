...
- Decidir se a assimetria de tratamento do campo militar em `densidade_militar_sia_pandora.png` (SIA bruto, PAN refinado) é mantida na tese ou se o gráfico precisa ser regerado em uma versão simétrica (ambas brutas, ou ambas refinadas com uma desambiguação manual aplicada a SIA).
